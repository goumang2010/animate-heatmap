...
Heatmap.prototype = {
     ...
     */
    getCanvas: function getCanvas(data, width, height) {
        this.data = data;
    ...
    getCanvasData: function getCanvasData(ctx, data) {
    ...
    refreshCanvas: function refreshCanvas(canvas, data, dx, dy, width, height) {
